...
import { addDualDialogTag, after } from '@bitsy/hecks/src/helpers/kitsy-script-toolkit';
import { createAudio, getRoom } from '@bitsy/hecks/src/helpers/utils';
...
export var hackOptions = {
	...
	audio: {
		...
		'MUSIC': { src: './forest.mp3', loop: true, volume: 0.75 }
	},
